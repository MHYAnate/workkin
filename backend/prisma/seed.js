...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var autoTransportCategory, homePropertyCategory, lifestyleProfessionalCategory, autoTransportServices, _i, autoTransportServices_1, service, homePropertyServices, _a, homePropertyServices_1, service, lifestyleServices, _b, lifestyleServices_1, service, systemSettings, _c, systemSettings_1, setting;
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 3:
                    ...
                    _i = 0, autoTransportServices_1 = autoTransportServices;
                    _d.label = 4;
                case 4:
                    if (!(_i < autoTransportServices_1.length)) return [3 /*break*/, 7];
                    service = autoTransportServices_1[_i];
                    return [4 /*yield*/, prisma.serviceType.upsert({
                ...
                case 7:
                    ...
                    _a = 0, homePropertyServices_1 = homePropertyServices;
                    _d.label = 8;
                case 8:
                    if (!(_a < homePropertyServices_1.length)) return [3 /*break*/, 11];
                    service = homePropertyServices_1[_a];
                    return [4 /*yield*/, prisma.serviceType.upsert({
                            where: { serviceId: service.serviceId },
                            update: {},
                            create: {
                ...
                case 11:
                    ...
                    _b = 0, lifestyleServices_1 = lifestyleServices;
                    _d.label = 12;
                case 12:
                    if (!(_b < lifestyleServices_1.length)) return [3 /*break*/, 15];
                    service = lifestyleServices_1[_b];
                    return [4 /*yield*/, prisma.serviceType.upsert({
                            where: { serviceId: service.serviceId },
                            update: {},
                            create: {
                ...
                case 15:
                    ...
                    _c = 0, systemSettings_1 = systemSettings;
                    _d.label = 16;
                case 16:
                    if (!(_c < systemSettings_1.length)) return [3 /*break*/, 19];
                    setting = systemSettings_1[_c];
